...
- Decoration category had the **highest average COGS (~$5000)**
...
- **"Doughnut Lip Gloss"**
  - Highest inventory turnover (**1.97**)
  - Sells **almost twice as fast as average**
...
- **"Set of 6 Soldier Skittles"**
  - Highest growth in sales from **2020 to 2021**
  - Indicates rising popularity of classic decorations

- **"Jazz Hearts Address Book"**
  - Highest inventory turnover among **C-class items**
...
- However:
  ...
  - Suggests **understocking despite high demand**

- Difference in average turnover:
  - **A vs B class items = 0.209**
...
- Observations:
  - Key products ("Doughnut Lip Gloss", "Grow a Flytrap", "Soldier Skittles") fall under **Class A**
  - **2 categories have no A-class items**:
    - Office & School
    - Jewelry

- UK customers:
  - **14.95% of orders are A-class items**
  - Higher than average → preference for high-value products
...
- Some categories:
  - High turnover but low revenue → **stock imbalance**
...
- Re-evaluate:
  - **Class C items** with high turnover (potential hidden value)
...
- Improve performance of:
  ...
  - Jewelry
- Investigate:
  - Why these categories lack A-class products
